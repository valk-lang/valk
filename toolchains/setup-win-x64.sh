...
LLVM_WIN_X64="$LIB_DIR/win-llvm-22-x64"
...
if [ ! -d "$LLVM_WIN_X64" ]; then
	...
	cd $LIB_DIR
	wget "https://files.valk-cdn.dev/toolchains/win-llvm-22-x64.tar.gz"
	tar -xf "win-llvm-22-x64.tar.gz" --checkpoint=.100
	rm "win-llvm-22-x64.tar.gz"
fi
