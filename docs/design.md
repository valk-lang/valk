...
//
// Unsafe void pointer: *void (rawpointer)
...
-- Otherwise it's an offset/generic body `[{expr}, {expr}, ...]`
...
- Struct objects are allocated by `mem:alloc`
- All other dynamic allocations are allocated by `gc:alloc`
