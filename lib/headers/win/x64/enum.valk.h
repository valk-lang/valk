...
value INVALID_HANDLE_VALUE (-1.@cast(uint))
value INVALID_SOCKET (-1.@cast(uint))

value IPPROTO_TCP (6)
value IPPROTO_UDP (17)

value SIO_GET_EXTENSION_FUNCTION_POINTER (IOC_INOUT|IOC_WS2|6)

value STATUS_SUCCESS (0)
value STATUS_PENDING (0x00000103)
